...
class _PlayGameState extends State<PlayGame> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ElevatedButton(
            onPressed:
                (turn == 1 && player1 == widget.username && player2.isNotEmpty)
                    ? () => _submitMove()
                    : (turn == 2 &&
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  ...
                  children: [
                    if (shipLocations
                        .contains('${String.fromCharCode(row + 64)}${col}'))
                      Icon(Icons.directions_boat, color: Colors.green)
                    else if (wreckShipsCoordinates
                        .contains('${String.fromCharCode(row + 64)}${col}'))
                      Icon(Icons.bubble_chart, color: Colors.blue),
                    if (sunkShipCoordinates
                        .contains('${String.fromCharCode(row + 64)}${col}'))
                      Icon(Icons.block,
                          color: Colors.yellow) // Display bolt icon
                    else if (shotCoordinates
                        .contains('${String.fromCharCode(row + 64)}${col}'))
  ...
  void _submitMove() async {
    ...
    String shotLocation =
        '${String.fromCharCode(selectedRow + 64)}$selectedCol';
