      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          completedGames = fetchedCompletedGames
              .where((game) =>
                  game.status == 1 ||
                  game.status == 2) // Completed game statuses
              .toList();
        });
      } else {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => PlayGame(
                      gameId: completedGames[index].id,
              ...
              child: ListTile(
                ...
                subtitle: Row(
                  children: [
                    ...
                    Flexible(
                      child: Text(
                          '${completedGames[index].player2 ?? 'Waiting for opponent'}'),
                    ),
                    SizedBox(width: 16),
                    Flexible(
                      child: Text(
                          '${_getStatusText(completedGames[index].status)}'),
                    ),
                  ],
                ),
              ),
